...
class Fee():
    def __init__(self, master):
        ...
        Frame_1 = LabelFrame(Data_Frame, width=850, height=350, bg='lightskyblue', relief='ridge', bd=8,
                             text='Informations', font=('arial', 15, 'bold'))
        Frame_1.pack(side=LEFT, padx=10)

        Frame_2 = LabelFrame(Data_Frame, width=495, height=350, bg='lightskyblue', relief='ridge', bd=8,
